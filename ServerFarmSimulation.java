...
public class ServerFarmSimulation {
    ...
    public static void main(String[] args) {
        ...
        String dispatcherType = "balanced" ; //Which jobDispatcher to use
        ...
        // Extension 2
        else if ( dispatcherType == "balanced" ) {
            dispatcher = new BalancedDispatcher( numServers , showViz ) ; 
        }
        ...
        System.out.println( "jobDispatcher: " + dispatcherType + "\nAvg. Wait time: " + dispatcher.getAverageWaitingTime() ) ;
